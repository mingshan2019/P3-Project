...
export default function Intro() {
    return (
        ...
        <div style={{left:'25%',right:'45%',top:'35%',bottom:'25%',position:'absolute',transform: 'translateX(-50%)',background:'#d9d9d9',borderRadius:'2%',opacity:0.95,padding:'4%'}}>
        <h1>Everything you are, in simple one link</h1>  
        <br/> 
        <br/> 
        <div></div><h2><Link to='/SignUp'>Register Today <ArrowRightOutlined /></Link></h2>
        </div>
        </div>
    )
}
